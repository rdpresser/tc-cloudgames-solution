    ...
    public class ServiceParameterRegistry
    {
        ...
        public AzureServiceBusServiceConfig GetAzureServiceBusConfig(ConfigurationManager configuration, ILogger? logger = null)
        {
            ...
            return new AzureServiceBusServiceConfig
            {
                ...
                UsersTopicName = ServiceConfigResolver.GetResolvedValue("AzureServiceBus:UsersTopicName", "AZURE_SERVICEBUS_USERS_TOPIC_NAME", configuration, "user.events", logger),
                GamesTopicName = ServiceConfigResolver.GetResolvedValue("AzureServiceBus:GamesTopicName", "AZURE_SERVICEBUS_GAMES_TOPIC_NAME", configuration, "game.events", logger),
                PaymentsTopicName = ServiceConfigResolver.GetResolvedValue("AzureServiceBus:PaymentsTopicName", "AZURE_SERVICEBUS_PAYMENTS_TOPIC_NAME", configuration, "payment.events", logger),
