...
{
    /// <summary>
    /// Tipos de projetos suportados na solu��o
    /// </summary>
    ...
    public record CacheServiceConfig : ServiceConfig
    {
        ...
        /// <summary>
        /// Obt�m o nome da inst�ncia para um projeto espec�fico
        /// </summary>
        ...
        /// <summary>
        /// Cria configura��o de cache a partir da configura��o do sistema
        /// </summary>
